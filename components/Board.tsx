      ...
      <div className="board">
        <div className=" w-[300px] md:[w-400px] rounded-lg flex items-center justify-center space-x-10">
          <div>
            {playerX
              ?
              <div className="px-4 py-1 text-xl font-medium text-white uppercase bg-gray-700 rounded-lg w-28">
          ...
          <button onClick={handleRestartGame} className="group button px-2 py-1 hover:ring-4 hover:ring-cyan-300 rounded-md bg-[#f3b236] hover:bg-[#30c4bd]" >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transition duration-300 group-hover:rotate-180 eas-in " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
